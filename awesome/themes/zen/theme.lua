...
wp_path = "/home/ashedko/Images/wallpaper/"
function wplist()
    local t,i, popen  = {}, 0, io.popen
    for l in popen("ls ".. wp_path):lines() do
        i = i + 1
        t[i] = l
    end
    return t,i
end
local files,cnt = wplist()
local idx = os.time() % cnt + 1

theme.wallpaper = wp_path .. files[idx]
-- theme.wallpaper = "/home/ashedko/Images/wallpaper/colorGirl.jpg"
-- }}}
